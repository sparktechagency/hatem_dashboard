   ...
   const isSectionComplete = (section: Section): boolean => {
      ...
      return section.fields.every(
         (field) =>
            ...
            (field.valueString?.trim() || field.valueFloat !== undefined)
      );
   };
         ...
         <CardHeader>
            <div className="flex items-center justify-between">
               <div>
                  ...
                  <CardDescription>
                     Add product specifications and details sections
                  </CardDescription>
               </div>
               <Button
                  onClick={addSection}
                  ...
                  >
                     <div className="flex items-end gap-2">
                        <div className="flex-1 space-y-2">
                           <Label htmlFor={`section-name-${sectionIndex}`}>
                              Section Name *
                           </Label>
                           <Input
                        ...
                        {section.fields.map((field, fieldIndex) => (
                           <div key={fieldIndex} className="space-y-2">
                              <div className="flex items-end gap-2">
                                 <div className="flex-1 space-y-2">
                                    <Label
                                       htmlFor={`field-name-${sectionIndex}-${fieldIndex}`}
                                    >
                                       Field Name
                                    </Label>
                                    <Input
                                 ...
                                 <div className="flex-1 space-y-2">
                                    <Label
                                       htmlFor={`field-value-${sectionIndex}-${fieldIndex}`}
                                    >
                                       Value
                                    </Label>
                                    <Input
